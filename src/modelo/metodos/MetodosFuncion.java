...
//-----------------------------------------------------------------------------------------------hasta aqui
    ...
    public void crearFuncionBBDD(LocalDateTime diaYHora, Sala salaFuncion, Pelicula peliculaFuncion,
        ...
        String q = " INSERT INTO funcion (diaYHora, sala_idSalaCine, peliculaFuncion, cine_nombreCine)" + "VALUES ("
                + diaYHora + "," + salaFuncion.getIdSalaCine() + "," + peliculaFuncion.getIdPelicula() + "," + cine_nombreCine.getNombreCine() + ")";
        // se ejecuta la consulta
        try {
            PreparedStatement pstm = this.getConexion().prepareStatement(q);
            pstm.execute();
    ...
    public void actualizarFuncionBBDD(LocalDateTime diaYHoraAntiguo, LocalDateTime diaYHora, Sala salaFuncion,
        ...
        // se arma la consulta
        String q = " UPDATE funcion " + "SET diaYHora = '" + diaYHora + "', PeliculaFuncion = '" + peliculaFuncion
                + "', cine_nombreCine = '" + cine_nombre.getNombreCine() + "', sala_idSalaCine = '" + salaFuncion.getIdSalaCine() + "'"
